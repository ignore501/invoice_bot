...
async def process_calendar_selection(update: Update):
    """
    ...
    indicating if a date is selected and returning the date if so.
    """
    ret_data = [False, None]
...
#     message_id=query.message.message_id
        ...
        await update.callback_query.edit_message_text(
            ...
            reply_markup=create_calendar(int(pre.year),
                                         int(pre.month)))
# bot.edit_message_text(text=query.message.text,
#     chat_id=query.message.chat_id,
#     message_id=query.message.message_id,
#     reply_markup=create_calendar(int(pre.year),int(pre.month)))
        ...
        await update.callback_query.edit_message_text(
            "Please select a date:",
            reply_markup=create_calendar(int(ne.year),
                                         int(ne.month)))
# bot.edit_message_text(text=query.message.text,
#     chat_id=query.message.chat_id,
#     message_id=query.message.message_id,
#     reply_markup=create_calendar(int(ne.year),int(ne.month)))
        ...
        await update.callback_query.answer(text="Something went wrong!")
# bot.answer_callback_query(callback_query_id=
# query.id,text="Something went wrong!")
        # UNKNOWN
